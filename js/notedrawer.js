...
class NoteDrawer {
  ...
  drawOneNote(note = this.note) {
    ...
    var staveLenght =
      div.clientWidth - (10 / 100) * div.clientWidth - braceOffset;
    ...
    var voiceBass = new VF.Voice({ num_beats: 4, beat_value: 4 }).addTickables(
      bassNotes
    );
    ...
    var formatter = new VF.Formatter()
      ...
      .format([voiceTreble, voiceBass], staveLenght);
    ...
    svg.setAttribute(
      "viewBox",
      "0 0 " + div.clientWidth + " " + div.clientHeight
    );
